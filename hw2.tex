...
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage[left=0.5in, right=0.5in, top=0.825in, bottom=0.5in]{geometry}
\usepackage{fancyhdr}
\usepackage{graphicx}
...
\begin{document}
\vspace*{-5mm} % Move the first question slightly further away from the header bar
\begin{enumerate}
\item \input{hw2-p1.tex}
\item \input{hw2-p2.tex}
\item \input{hw2-p3.tex}
\item \input{hw2-p4.tex}
\item \input{hw2-p5.tex}
\item \input{hw2-p6.tex}
\item \input{hw2-p7.tex}
\item \input{hw2-p8.tex}
\end{enumerate}
\end{document}
